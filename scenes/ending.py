...
class EndGameScene:
    def __init__(self, screen, manager, bg_image, sound_func):
        ...
        self.button_play_again = pygame.transform.scale(pygame.image.load("assets/back_icon.png"), (450, 190))
        ...
        self.buttons = {
            "play_again": self.button_play_again.get_rect(center=(SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2 + 100)),

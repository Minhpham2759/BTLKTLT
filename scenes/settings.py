...
class OpenSettingScene(SettingsScene):
    def __init__(self, screen, manager):
        button_data = {
            ...
            "quit": {"image": "assets/quit_icon.png", "size": (150, 70), "position": (SCREEN_WIDTH - 100, SCREEN_HEIGHT - 60)},
        }
...
class PlaySettingScene(SettingsScene):
    def __init__(self, screen, manager):
        button_data = {
            "restart": {"image": "assets/back_icon.png", "size": (300, 120), "position": (SCREEN_WIDTH // 2, SCREEN_HEIGHT - 120)},
            "home": {"image": "assets/home_icon.png", "size": (100, 100), "position": (SCREEN_WIDTH // 2, SCREEN_HEIGHT - 200)},
            "quit": {"image": "assets/quit_icon.png", "size": (150, 70), "position": (SCREEN_WIDTH - 100, SCREEN_HEIGHT - 60)},
            "resume": {"image": "assets/resume_icon.png", "size": (300, 120), "position": (SCREEN_WIDTH // 2, SCREEN_HEIGHT - 300)},
        }
        super().__init__(screen, manager, button_data)
